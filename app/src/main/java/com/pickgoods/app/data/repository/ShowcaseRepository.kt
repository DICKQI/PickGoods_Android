...
class ShowcaseRepository @Inject constructor(
    ...
    suspend fun addGoods(showcaseId: String, goodsId: String): GoodsResult<ShowcaseGoods> = safeCall {
        showcaseApi.addGoods(showcaseId, ShowcaseAddGoodsRequest(goodsId)).toGoodsResult()
    }
    ...
    suspend fun moveGoods(
        ...
        position: String
    ): GoodsResult<Map<String, String>> = safeCall {
